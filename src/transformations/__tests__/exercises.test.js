...
const solutions = {
  ...
  'ex-14': [{ type: 'join', params: { column: 'ID' } }, { type: 'delete', params: { column: 'Temp' } }, { type: 'sort', params: { column: 'Montant', order: 'desc' } }],
  'ex-15': [{ type: 'select', params: { columns: ['Code', 'Valeur'] } }, { type: 'rename', params: { oldName: 'Code', newName: 'Reference' } }, { type: 'fill_na', params: { column: 'Valeur', value: '0' } }, { type: 'sort', params: { column: 'Reference', order: 'asc' } }],
  'ex-16': [{ type: 'delete_na' }, { type: 'drop_duplicates' }, { type: 'filter', params: { column: 'Priorite', value: 'Haute' } }, { type: 'delete', params: { column: 'Notes' } }],
  'ex-17': [{ type: 'concat' }, { type: 'drop_duplicates' }, { type: 'sort', params: { column: 'Date', order: 'asc' } }],
  'ex-18': [{ type: 'join', params: { column: 'Code' } }, { type: 'select', params: { columns: ['Code', 'Nom', 'Categorie', 'Prix'] } }, { type: 'rename', params: { oldName: 'Code', newName: 'SKU' } }, { type: 'sort', params: { column: 'Prix', order: 'desc' } }, { type: 'filter', params: { column: 'Categorie', value: 'A' } }],
